...
int main(int argc, char **argv) {
    if (argc != 13) {
        fprintf(stderr, "Usage: %s p1Null p2Null isValidp1 isValidp2 isStringp1 isStringp2 isDisjointp1p2 sizeof1 sizeof2 strlen1 strlen2 n\n", argv[0]);
        return 2;
    }
    ...
    /* call target function returning size_t */
    size_t r = strlcat(p1, p2, n);
    (void)r;
